...
bool custom_msgs_srvs__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs_srvs.msg._detection.Detection", full_classname_dest, 41) == 0);
  }
  custom_msgs_srvs__msg__Detection * ros_message = _ros_message;
  {  // x
...
PyObject * custom_msgs_srvs__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs_srvs.msg._detection");
